/**   Build A Simple Calculator using Java AWT, which can perform regular arithmatic operations.
 *    
 *    @author Amelia Dutta
 */
...
class Calculator extends WindowAdapter implements ActionListener{ 
  ...
  Button badd,bsub,bmult,bdiv,bcalc,bclr,bpts;
  double xd;
  ...
  badd=new Button("+");
    badd.setBounds(260,410,50,50);
  bsub=new Button("-");
    bsub.setBounds(260,340,50,50);
  bmult=new Button("*");
    bmult.setBounds(260,270,50,50);
  bdiv=new Button("/");
    bdiv.setBounds(260,200,50,50);
  bcalc=new Button("=");
    bcalc.setBounds(180,410,65,50);
    bcalc.setBackground(Color.GREEN);
  bclr=new Button("C"); 
    bclr.setBounds(240,130,65,50);
...
//MAIN METHOD where objects of Calculator is instantaiated
